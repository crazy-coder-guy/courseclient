    ...
    return (
      <div className="min-h-screen bg-yellow-50 flex items-center justify-center">
        <motion.div
          ...
          className="w-14 h-14 border-4 border-t-blue-900 border-gray-200 rounded-full"
        />
      </div>
    );
  }
    ...
    return (
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-4">
          <h1 className="text-3xl font-extrabold text-red-950 mb-4">Checkout</h1>
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
          <div className="lg:col-span-3 space-y-4">
            <motion.div
              ...
              className="bg-yellow-50 border border-gray-200"
            >
              <div className="px-4 py-3 border-b border-gray-100">
                <h2 className="text-xl font-bold text-red-950 0">Billing Information</h2>
              </div>
              <div className="px-4 py-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="relative">
                    <label className="block text-base font-semibold text-red-950  mb-1">
                      First Name *
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full border border-gray-300 px-3 py-2 text-base text-red-950 bg-yellow-100 focus:outline-none focus:border-blue-900 focus:ring-1 focus:ring-blue-900 transition-all font-medium"
                    />
                  </div>
                  <div className="relative">
                    <label className="block text-base font-semibold text-red-950  mb-1">
                  ...
                  <div className="md:col-span-2 relative">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className={`w-full border ${error && (billingAddress.length < 15 || !billingAddress) ? 'border-red-500' : 'border-gray-300'} px-3 py-2 text-base text-red-950 bg-yellow-100  focus:outline-none focus:border-blue-900 focus:ring-1 focus:ring-blue-900 transition-all resize-none font-medium`}
                    />
            ...
            <motion.div
              ...
              className="bg-yellow-50  border border-gray-200 p-4"
            >
              <h2 className="text-xl font-bold text-red-950  mb-4">Why Choose This Course?</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <motion.div
                    ...
                    className="p-3 bg-yellow-50 border border-gray-200"
                  >
                    <h3 className="text-base font-bold text-red-950 ">{item.title}</h3>
                    <p className="text-sm text-red-950 font-medium">{item.desc}</p>
                  </motion.div>
                ))}
              </div>
            </motion.div>
          ...
          <div className="lg:col-span-2">
            <motion.div
              ...
              animate={{ x: 0, opacity: 1 }}
              transition={{ delay: 0.2 }}
              className="bg-yellow-50 border border-gray-200 sticky top-24"
            >
              <div className="p-4 border-b border-gray-100">
                <div className="flex space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-base text-red-950  mb-1 leading-tight">
                      {course?.course_name || 'Course Name'}
                    </h3>
                    <p className="text-sm text-red-950 mb-1 font-medium">
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <span className="text-sm text-red-950 font-medium">4.8 (2,847)</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 border-b border-gray-100">
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-base text-red-950 font-medium">Original Price:</span>
                    <span className="text-base font-semibold text-blue-900">₹{course?.price?.toLocaleString('en-IN') || '0'}</span>
                  </div>
                  {isDiscounted && (
                    <motion.div
                      initial={{ opacity: 0 }}
                    ...
                    >
                      <span className="text-base text-red-950 font-medium">Discount ({discountPercentage}% off):</span>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-lg font-bold text-red-950 ">Total:</span>
                    <span className="text-lg font-extrabold text-red-950 ">₹{finalPrice?.toLocaleString('en-IN') || '0'}</span>
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {course.downloadable_resources && (
                      <div className="inline-flex items-center gap-2 bg-red-950 text-red-950 px-4 py-2 rounded-full shadow-sm">
                    ...
                    <div className="inline-flex items-center gap-2 bg-red-950 text-yellow-50 px-4 py-2 rounded-full shadow-sm">
                      <svg className="w-5 h-5 bg-red-950 text-yellow-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                <div className="bg-red-950 text-yellow-50 border border-blue-200 p-3">
                  <div className="flex items-center space-x-2 mb-1">
                    <svg className="w-5 h-5 text-yellow-50" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="font-extrabold text-base text-yellow-50">Secure Payment</span>
                  </div>
                  <p className="text-base text-yellow-50 font-medium">
              ...
              <div className="p-4">
                <motion.button
                  ...
                  disabled={loading}
                  className="w-full bg-red-950 text-yellow-50 font-bold py-3 text-base hover:bg-red-800 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
        ...
        <div className="flex flex-col md:flex-row bg-yellow-50 rounded-lg overflow-hidden p-6 md:p-8 gap-6">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="text-red-950 text-base leading-relaxed">
