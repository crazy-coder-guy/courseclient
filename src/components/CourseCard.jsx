  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-video overflow-hidden">
        ...
        {/* Badge */}
        {course.bestseller && (
          <div className="absolute top-2 left-2 bg-yellow-300 text-[10px] font-semibold px-1.5 py-0.5 text-black rounded-sm shadow">
            Bestseller
          </div>
        )}
      </div>
      ...
      {/* Content */}
      <div className="p-3">
        <h3 className="text-sm font-semibold text-gray-900 line-clamp-2 group-hover:text-purple-700 transition">
          {course.course_name || 'Untitled Course'}
        </h3>
        <p className="text-xs text-gray-900 mb-2 line-clamp-1">
        ...
        <div className="flex justify-between items-center mb-2">
          <div className="flex items-center space-x-2">
            <span className="text-sm font-bold text-purple-800 bg-purple-50 px-2 py-1 rounded">
